...
import { Settings, LogOut, Menu, X, LayoutDashboard, Users, ClipboardList, TrendingUp, Calendar } from 'lucide-react'
...
const managerNavItems = [
    ...
    {
        href: '/portal/manager/team',
        label: 'Team',
        icon: Users,
    },
    {
        href: '/portal/manager/tasks',
        label: 'Tasks',
        icon: ClipboardList,
    },
    {
