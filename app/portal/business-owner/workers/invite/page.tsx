...
export default function InviteTeamPage() {
    const [invites, setInvites] = useState([{ email: '', role: 'Member', department: '', business: '' }])
    ...
    const addInvite = () => {
        setInvites([...invites, { email: '', role: 'Member', department: '', business: '' }])
    }
    ...
    return (
        <div className="p-6 space-y-8 w-[95%] mx-auto">
            ...
            <div className="space-y-3">
                <Link href="/portal/business-owner/workers" className="flex items-center gap-2 text-primary hover:text-primary/80 text-sm mb-4">
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {invites.map((invite, index) => (
                            <div key={index} className="p-6 border border-border/50 rounded-lg bg-foreground/5 space-y-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mt-2">
                                            ...
                                            <Input
                                                ...
                                                className="pl-10 py-6 bg-input border-primary/40 text-foreground placeholder:text-foreground/40"
                                                required
                                            />
                                        </div>
                                    </div>
                                    ...
                                    {/* Business Selection */}
                                    <div>
                                        <Label htmlFor={`business-${index}`} className="text-foreground">
                                            Business *
                                        </Label>
                                        <Select value={invite.business} onValueChange={(value) => updateInvite(index, 'business', value)}>
                                            <SelectTrigger className="mt-2 bg-input border-primary/40 text-foreground w-full py-6">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-border/50">
                        <Link href="/portal/business-owner/workers" className="flex-1">
