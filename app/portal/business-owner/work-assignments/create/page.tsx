...
export default function CreateTaskPage() {
    ...
    return (
        <div className="p-6 space-y-8 w-[85%] mx-auto">
            {/* Header */}
            <div className="space-y-2">
                <Link href="/portal/business-owner/work-assignments" className="flex items-center gap-2 text-primary hover:text-primary/80 text-sm mb-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            className="mt-2 bg-input border-primary/40 text-foreground placeholder:text-foreground/40 py-6"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            className="mt-2 min-h-32 bg-input border-primary/40 text-foreground placeholder:text-foreground/40"
                        />
                    </div>
                    ...
                    <div className="flex gap-3 pt-4 border-t border-border/50">
                        <Link href="/portal/business-owner/work-assignments" className="flex-1">
